    ...
    <header className="flex items-center w-full p-4 md:py-2 md:px-6">
      ...
      >
        ...
        <div className="flex flex-col">
          <p className="text-black text-lg hover:text-headingColor font-bold">
            {user?.user.name}
          </p>
        </div>
        ...
        {isMenu && (
          <motion.div
            ...
            exit={{ opacity: 0, y: 50 }}
            className="absolute z-10 top-12 right-0 w-275 p-4 gap-4 text-textColor shadow-lg rounded-lg backdrop-blur-sm flex flex-col"
          >
            ...
            <p
              className="text-base text-black hover:font-semibold duration-150 transition-all ease-in-out"
              onClick={logout}
            >
              Sign out
            </p>
